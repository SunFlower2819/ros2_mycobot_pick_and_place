...
#include "robocallee_fms/msg/detail/aruco_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robocallee_fms::msg::ArucoPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robocallee_fms::msg::ArucoPose & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robocallee_fms::msg::ArucoPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robocallee_fms::msg::ArucoPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robocallee_fms::msg::ArucoPose *>(
    untyped_ros_message);
...
{
  return &robocallee_fms::msg::typesupport_fastrtps_cpp::_ArucoPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robocallee_fms, msg, ArucoPose)() {
  return &robocallee_fms::msg::typesupport_fastrtps_cpp::_ArucoPose__handle;
}
