...
static const _ArucoPoseArray_type_support_symbol_names_t _ArucoPoseArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robocallee_fms, msg, ArucoPoseArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robocallee_fms, msg, ArucoPoseArray)),
  }
};
...
{
  return &::robocallee_fms::msg::rosidl_typesupport_cpp::ArucoPoseArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robocallee_fms, msg, ArucoPoseArray)() {
  return get_message_type_support_handle<robocallee_fms::msg::ArucoPoseArray>();
}
