...
custom_messeage__srv__RobotArmRequest_Request__create(void)
{
  ...
  custom_messeage__srv__RobotArmRequest_Request * msg = (custom_messeage__srv__RobotArmRequest_Request *)allocator.allocate(sizeof(custom_messeage__srv__RobotArmRequest_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_messeage__srv__RobotArmRequest_Request));
  bool success = custom_messeage__srv__RobotArmRequest_Request__init(msg);
  if (!success) {
...
custom_messeage__srv__RobotArmRequest_Request__Sequence__init(custom_messeage__srv__RobotArmRequest_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Request * data = NULL;

  if (size) {
    data = (custom_messeage__srv__RobotArmRequest_Request *)allocator.zero_allocate(size, sizeof(custom_messeage__srv__RobotArmRequest_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_messeage__srv__RobotArmRequest_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_messeage__srv__RobotArmRequest_Request__fini(&data[i - 1]);
      }
...
custom_messeage__srv__RobotArmRequest_Request__Sequence__fini(custom_messeage__srv__RobotArmRequest_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_messeage__srv__RobotArmRequest_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Request__Sequence * array = (custom_messeage__srv__RobotArmRequest_Request__Sequence *)allocator.allocate(sizeof(custom_messeage__srv__RobotArmRequest_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_messeage__srv__RobotArmRequest_Request__Sequence__init(array, size);
  if (!success) {
...
custom_messeage__srv__RobotArmRequest_Request__Sequence__destroy(custom_messeage__srv__RobotArmRequest_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_messeage__srv__RobotArmRequest_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_messeage__srv__RobotArmRequest_Request__Sequence__are_equal(const custom_messeage__srv__RobotArmRequest_Request__Sequence * lhs, const custom_messeage__srv__RobotArmRequest_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_messeage__srv__RobotArmRequest_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_messeage__srv__RobotArmRequest_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_messeage__srv__RobotArmRequest_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_messeage__srv__RobotArmRequest_Request * data =
      (custom_messeage__srv__RobotArmRequest_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_messeage__srv__RobotArmRequest_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_messeage__srv__RobotArmRequest_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_messeage__srv__RobotArmRequest_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Response * msg = (custom_messeage__srv__RobotArmRequest_Response *)allocator.allocate(sizeof(custom_messeage__srv__RobotArmRequest_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_messeage__srv__RobotArmRequest_Response));
  bool success = custom_messeage__srv__RobotArmRequest_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
custom_messeage__srv__RobotArmRequest_Response__Sequence__init(custom_messeage__srv__RobotArmRequest_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Response * data = NULL;

  if (size) {
    data = (custom_messeage__srv__RobotArmRequest_Response *)allocator.zero_allocate(size, sizeof(custom_messeage__srv__RobotArmRequest_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_messeage__srv__RobotArmRequest_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        custom_messeage__srv__RobotArmRequest_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
custom_messeage__srv__RobotArmRequest_Response__Sequence__fini(custom_messeage__srv__RobotArmRequest_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_messeage__srv__RobotArmRequest_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Response__Sequence * array = (custom_messeage__srv__RobotArmRequest_Response__Sequence *)allocator.allocate(sizeof(custom_messeage__srv__RobotArmRequest_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_messeage__srv__RobotArmRequest_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
custom_messeage__srv__RobotArmRequest_Response__Sequence__destroy(custom_messeage__srv__RobotArmRequest_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_messeage__srv__RobotArmRequest_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_messeage__srv__RobotArmRequest_Response__Sequence__are_equal(const custom_messeage__srv__RobotArmRequest_Response__Sequence * lhs, const custom_messeage__srv__RobotArmRequest_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_messeage__srv__RobotArmRequest_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_messeage__srv__RobotArmRequest_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_messeage__srv__RobotArmRequest_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_messeage__srv__RobotArmRequest_Response * data =
      (custom_messeage__srv__RobotArmRequest_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_messeage__srv__RobotArmRequest_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_messeage__srv__RobotArmRequest_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_messeage__srv__RobotArmRequest_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
custom_messeage__srv__RobotArmRequest_Event__init(custom_messeage__srv__RobotArmRequest_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    custom_messeage__srv__RobotArmRequest_Event__fini(msg);
    return false;
  }
  // request
  if (!custom_messeage__srv__RobotArmRequest_Request__Sequence__init(&msg->request, 0)) {
    custom_messeage__srv__RobotArmRequest_Event__fini(msg);
    return false;
  }
  // response
  if (!custom_messeage__srv__RobotArmRequest_Response__Sequence__init(&msg->response, 0)) {
    custom_messeage__srv__RobotArmRequest_Event__fini(msg);
    return false;
  }
  return true;
...
custom_messeage__srv__RobotArmRequest_Event__fini(custom_messeage__srv__RobotArmRequest_Event * msg)
{
  ...
  // request
  custom_messeage__srv__RobotArmRequest_Request__Sequence__fini(&msg->request);
  // response
  custom_messeage__srv__RobotArmRequest_Response__Sequence__fini(&msg->response);
}
...
custom_messeage__srv__RobotArmRequest_Event__are_equal(const custom_messeage__srv__RobotArmRequest_Event * lhs, const custom_messeage__srv__RobotArmRequest_Event * rhs)
{
  ...
  // request
  if (!custom_messeage__srv__RobotArmRequest_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!custom_messeage__srv__RobotArmRequest_Response__Sequence__are_equal(
  ...
  custom_messeage__srv__RobotArmRequest_Event * output)
{
  ...
  // request
  if (!custom_messeage__srv__RobotArmRequest_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!custom_messeage__srv__RobotArmRequest_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Event * msg = (custom_messeage__srv__RobotArmRequest_Event *)allocator.allocate(sizeof(custom_messeage__srv__RobotArmRequest_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_messeage__srv__RobotArmRequest_Event));
  bool success = custom_messeage__srv__RobotArmRequest_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
custom_messeage__srv__RobotArmRequest_Event__Sequence__init(custom_messeage__srv__RobotArmRequest_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Event * data = NULL;

  if (size) {
    data = (custom_messeage__srv__RobotArmRequest_Event *)allocator.zero_allocate(size, sizeof(custom_messeage__srv__RobotArmRequest_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_messeage__srv__RobotArmRequest_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        custom_messeage__srv__RobotArmRequest_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
custom_messeage__srv__RobotArmRequest_Event__Sequence__fini(custom_messeage__srv__RobotArmRequest_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_messeage__srv__RobotArmRequest_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_messeage__srv__RobotArmRequest_Event__Sequence * array = (custom_messeage__srv__RobotArmRequest_Event__Sequence *)allocator.allocate(sizeof(custom_messeage__srv__RobotArmRequest_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_messeage__srv__RobotArmRequest_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
custom_messeage__srv__RobotArmRequest_Event__Sequence__destroy(custom_messeage__srv__RobotArmRequest_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_messeage__srv__RobotArmRequest_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_messeage__srv__RobotArmRequest_Event__Sequence__are_equal(const custom_messeage__srv__RobotArmRequest_Event__Sequence * lhs, const custom_messeage__srv__RobotArmRequest_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_messeage__srv__RobotArmRequest_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_messeage__srv__RobotArmRequest_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_messeage__srv__RobotArmRequest_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_messeage__srv__RobotArmRequest_Event * data =
      (custom_messeage__srv__RobotArmRequest_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_messeage__srv__RobotArmRequest_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_messeage__srv__RobotArmRequest_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_messeage__srv__RobotArmRequest_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
